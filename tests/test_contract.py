...
"""Kontrakt connectora llm konformuje i pokrywa KAŻDĄ trasę handlera (anty-dryf)."""
...
PKG = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "urirun_connector_llm")
